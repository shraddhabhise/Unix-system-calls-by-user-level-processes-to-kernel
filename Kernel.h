...
-----------------------------  TestHoareSemantic  ---------------------------------
  ...
  --  This class is created to provide frame resources to the requesting threads
  --  This class provides a functionality of returning all frames at one time after finishing of there execution
  ...
  class FrameManager
    ...
    fields
      ...
      newFramesAvailable: Condition		     -- Condition variabe for  the leader thread
      GroupsWaiting: Condition                       -- Condition variabe for remaining requesting threads except the leader thread
